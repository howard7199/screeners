...
const categoryMap = {
    ...
    'Buffer': '緩衝型', 'Factor': '因子策略', 'Options': '選擇權策略',
...
function populateSelectors() {
    ...
    if (catSelect) {
        ...
        const catOrder = ['Equity','Bond','Sector','International','Dividend','Leveraged','Buffer','Factor','Options','Commodity','Real Estate','Thematic','Other'];
